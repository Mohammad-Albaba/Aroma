...
class Data {
  ...
  Data({this.pagination, this.products});
...
class Products {
  ...
  Products({this.id, this.title, this.subTitle, this.description, this.price, this.isFav, this.isRate, this.rateAvg, this.rates, this.remainingQty, this.hasOption, this.optionName, this.optionPrice, this.images, this.isShipping});
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    // if (json['rates'] != null) {
    //   rates = <Null>[];
    //   json['rates'].forEach((v) { rates.add(new Null.fromJson(v)); });
    // }
